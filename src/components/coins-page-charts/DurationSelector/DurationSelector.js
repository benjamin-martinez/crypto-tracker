...
const Selection = (props) => {
    return (
        <SWrapper active={props.duration.active} onClick={() => props.handleDurationClick(props.duration)}>
...
const DurationSelector = (props) => {
    return (
        <Wrapper>
            <ContentWrapper>
                {props.durations.map(duration => <Selection duration={duration} handleDurationClick={props.handleDurationClick}/>)}
            </ContentWrapper>
        </Wrapper>
    )
}
