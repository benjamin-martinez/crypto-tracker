      ...
      <SectionWrapper>
        ...
        <PriceDetails>
          <PriceDetailsInnerWrapper>
            <PriceWrapper>
              <ChartHeaderText>
                {addCommas(props.coin.market_data.current_price.usd)}
              </ChartHeaderText>
              <PercentWrapper>
              ...
              <PriceRangeWrapper>
                ...
                <PriceRangeTextWrapper>
                  <ATPriceWrapper>
                    ...
                    <PortfolioEntryText>
                      {addDecimalsAndShorten(props.coin.market_data.ath.usd)}
                    </PortfolioEntryText>
                  </ATPriceWrapper>
                  <span>
                    <PortfolioEntryText>
              ...
              <PriceRangeWrapper>
                ...
                <PriceRangeTextWrapper>
                  <ATPriceWrapper>
                    ...
                    <PortfolioEntryText>
                      {addDecimalsAndShorten(props.coin.market_data.atl.usd)}
                    </PortfolioEntryText>
                  </ATPriceWrapper>
                  <span>
                    <PortfolioEntryText>
            ...
            <MarketDetailsTop>
              <MarketDetailsLine>
                ...
                <MarketDetailsLineText>
                  ...
                  <PortfolioEntryText>
                    {addCommas(props.coin.market_data.market_cap.usd)}
                  </PortfolioEntryText>
                </MarketDetailsLineText>
              </MarketDetailsLine>
              <MarketDetailsLine>
              ...
              <MarketDetailsLine>
                ...
                <MarketDetailsLineText>
                  ...
                  <PortfolioEntryText>
                    {addCommas(props.coin.market_data.total_volume.usd)}
                  </PortfolioEntryText>
                </MarketDetailsLineText>
              </MarketDetailsLine>
              <MarketDetailsLine>
